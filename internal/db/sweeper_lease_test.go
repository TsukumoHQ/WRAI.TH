...
func TestMarkStaleAgentsInactive_LeaseHolderGuard(t *testing.T) {
	...
	t1, err := d.DispatchTask("p1", "dev", "cto", "live-lease", "", "P2", nil, nil, TypedTicket{}, false, nil)
	if err != nil {
	...
	t2, err := d.DispatchTask("p1", "dev", "cto", "expired-lease", "", "P2", nil, nil, TypedTicket{}, false, nil)
	if err != nil {
