...
func TestAPITaskTransition(t *testing.T) {
	...
	task, _ := r.DB.DispatchTask("p1", "dev", "bot-a", "task1", "", "P2", nil, nil, db.TypedTicket{})
...
func TestAPIGetAllTasks(t *testing.T) {
	r := testRelay(t)
	_, _, _ = r.DB.RegisterAgent("p1", "bot-a", "dev", "", nil, nil, false, nil, "[]", 0, db.RegisterOptions{})
	_, _ = r.DB.DispatchTask("p1", "dev", "bot-a", "task1", "", "P2", nil, nil, db.TypedTicket{})
	_, _ = r.DB.DispatchTask("p1", "dev", "bot-a", "task2", "", "P1", nil, nil, db.TypedTicket{})
...
func TestAPIGetBoardTasks(t *testing.T) {
	...
	_, _ = r.DB.DispatchTask("p1", "dev", "user", "native task", "", "P2", nil, nil, db.TypedTicket{})
...
func TestAPIGetBoardTasksExcludesCancelledAndArchived(t *testing.T) {
	r := testRelay(t)
	tk, _ := r.DB.DispatchTask("p1", "dev", "user", "keep me", "", "P2", nil, nil, db.TypedTicket{})
	cn, _ := r.DB.DispatchTask("p1", "dev", "user", "cancel me", "", "P2", nil, nil, db.TypedTicket{})
...
func TestAPIGetCyclesEmptyNative(t *testing.T) {
	r := testRelay(t)
	_, _ = r.DB.DispatchTask("p1", "dev", "user", "native only", "", "P2", nil, nil, db.TypedTicket{})
...
func TestAPIGetLatestTasks(t *testing.T) {
	r := testRelay(t)
	_, _, _ = r.DB.RegisterAgent("p1", "bot-a", "dev", "", nil, nil, false, nil, "[]", 0, db.RegisterOptions{})
	_, _ = r.DB.DispatchTask("p1", "dev", "bot-a", "recent task", "", "P2", nil, nil, db.TypedTicket{})
...
func TestAPIUpdateTask(t *testing.T) {
	r := testRelay(t)
	_, _, _ = r.DB.RegisterAgent("p1", "bot-a", "dev", "", nil, nil, false, nil, "[]", 0, db.RegisterOptions{})
	task, _ := r.DB.DispatchTask("p1", "dev", "bot-a", "old title", "", "P2", nil, nil, db.TypedTicket{})
...
func TestAPIDeleteTask(t *testing.T) {
	r := testRelay(t)
	_, _, _ = r.DB.RegisterAgent("p1", "bot-a", "dev", "", nil, nil, false, nil, "[]", 0, db.RegisterOptions{})
	task, _ := r.DB.DispatchTask("p1", "dev", "bot-a", "to delete", "", "P2", nil, nil, db.TypedTicket{})
